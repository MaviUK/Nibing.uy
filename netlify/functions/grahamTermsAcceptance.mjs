...
export default async () => {
  const pdf = await buildTermsAcceptancePdfAttachment({
    name: "Graham",
    email: "gavin@gerball.co.uk",
    phone: "07580021067",
    address: "29 Dermott Walk, Comber, Newtownards BT23 5NU, UK",
    ...
    termsTimestamp: "2026-09-03T10:41:57.000Z",
    termsBody: TERMS_BODY,
    source: "street-signup",
    verificationHash: "279a07800c28ca1258e6007dbaef2343bbfa0a435dcf05cd3837c0682d0e7fd4",
  });
...
export const config = {
  path: "/customer-documents/ni-bin-guy-terms-acceptance-graham.pdf",
};
