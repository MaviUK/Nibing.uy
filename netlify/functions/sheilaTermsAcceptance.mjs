...
export default async () => {
  const pdf = await buildTermsAcceptancePdfAttachment({
    name: "Sheila",
    email: "sheila@gerball.co.uk",
    phone: "07938991203",
    address: "19 Queens Square, Newtownards BT23 8LF, UK",
    ...
    termsTimestamp: "2026-09-04T08:58:35.000Z",
    termsBody: TERMS_BODY,
    source: "street-signup",
    verificationHash: "094c34ccf0f3febc5a7b098847e21fe92f197fd8f09bb1a6e9d8a58bf86133fd",
  });
...
export const config = {
  path: "/customer-documents/ni-bin-guy-terms-acceptance-sheila.pdf",
};
