    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#050505;margin:0;padding:0;">
      <tr><td align="center" style="padding:22px 10px;">
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:680px;background:#ffffff;border-radius:18px;overflow:hidden;">
          ...
          <tr><td style="padding:18px 26px 0;">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#090909;border-radius:14px;">
              ...
              <tr><td style="padding:16px 20px 20px;">
                <div style="font-family:Arial,sans-serif;color:#ffd400;font-size:12px;font-weight:700;text-transform:uppercase;">Service address</div>
                <div style="font-family:Arial,sans-serif;color:#ffffff;font-size:16px;line-height:1.5;padding-top:4px;">${escapeHtml(address)}</div>
                ${phone ? `<div style="font-family:Arial,sans-serif;color:#bdbdbd;font-size:14px;line-height:1.5;padding-top:6px;">${escapeHtml(phone)}</div>` : ""}
              </td></tr>
            </table>
          </td></tr>

          <tr><td style="padding:14px 26px 0;">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#ffd400;border-radius:14px;"><tr><td style="padding:20px;">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"><tr>
                <td width="38%" valign="top" style="padding-right:18px;border-right:1px solid #ad9200;">
                ...
                <td width="62%" valign="top" style="padding-left:18px;">
                  ...
                  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-top:1px solid #ad9200;margin-top:8px;">
          ...
          <tr><td style="padding:14px 26px 0;"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#c41230;border-radius:14px;">
          ...
          <tr><td style="padding:18px 26px 0;"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f4f4f4;border-radius:14px;">
            <tr><td style="padding:18px 20px;font-family:Arial,sans-serif;color:#222222;">
              ...
              <div style="font-size:12px;line-height:1.5;color:#666666;margin-top:7px;">${termsPdfAttached ? "Your branded Terms & Conditions Acceptance Certificate PDF is attached to this email." : "Your Terms acceptance has been recorded with your booking."}</div>
            </td></tr>
          </table></td></tr>

          <tr><td style="padding:18px 26px 26px;"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#ffd400;border-radius:14px;">
            <tr><td style="padding:18px 22px;text-align:center;font-family:Arial,sans-serif;color:#111111;">
              <div style="font-family:Arial Black,Arial,sans-serif;font-size:16px;font-weight:900;text-transform:uppercase;">🗑️ TODAY'S RUBBISH JOKE</div>
              <div style="font-size:15px;font-weight:700;line-height:1.5;margin-top:8px;">${escapeHtml(jokeQuestion)}</div>
              <div style="font-size:14px;line-height:1.5;margin-top:5px;">${escapeHtml(jokeAnswer)} 😂</div>
            </td></tr>
          </table></td></tr>
