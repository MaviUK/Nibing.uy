      ...
      <tr><td align="center" style="padding:22px 10px;">
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:680px;background:#ffffff;border-radius:18px;overflow:hidden;">
          ...
          <tr><td style="padding:18px 26px 0;"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#090909;border-radius:14px;">
            ...
            <tr><td style="padding:16px 20px 20px;"><div style="font-family:Arial,sans-serif;color:#ffd400;font-size:12px;font-weight:700;text-transform:uppercase;">Service address</div><div style="font-family:Arial,sans-serif;color:#ffffff;font-size:16px;line-height:1.5;padding-top:4px;">${escapeHtml(address)}</div>${phone ? `<div style="font-family:Arial,sans-serif;color:#bdbdbd;font-size:14px;line-height:1.5;padding-top:6px;">${escapeHtml(phone)}</div>` : ""}</td></tr>
          </table></td></tr>

          <tr><td style="padding:14px 26px 0;"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#ffd400;border-radius:14px;"><tr><td style="padding:20px;"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"><tr>
            <td width="38%" valign="top" style="padding-right:18px;border-right:1px solid #ad9200;"><div style="font-family:Arial Black,Arial,sans-serif;color:#111111;font-size:17px;text-transform:uppercase;font-weight:900;">YOUR PRICE</div><div style="font-family:Arial Black,Arial,sans-serif;color:#111111;font-size:52px;line-height:1;font-weight:900;margin-top:7px;">${escapeHtml(total)}</div><div style="font-family:Arial,sans-serif;color:#111111;font-size:12px;font-weight:700;text-transform:uppercase;">booking total</div></td>
            <td width="62%" valign="top" style="padding-left:18px;"><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">${priceRows}</table><table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-top:1px solid #ad9200;margin-top:8px;"><tr><td style="padding-top:10px;font-family:Arial,sans-serif;font-size:14px;">Subtotal</td><td align="right" style="padding-top:10px;font-family:Arial,sans-serif;font-size:14px;font-weight:700;">${escapeHtml(subtotal)}</td></tr>${code ? `<tr><td style="padding-top:5px;font-family:Arial,sans-serif;font-size:14px;color:#a00018;">Discount code</td><td align="right" style="padding-top:5px;font-family:Arial,sans-serif;font-size:14px;color:#a00018;font-weight:700;">${escapeHtml(code)}</td></tr>` : ""}</table></td>
